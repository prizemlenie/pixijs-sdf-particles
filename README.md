...
- **64,000 particles** rendered at 120fps via GPU instancing
...
> **Note:** The particle count can be increased several times without performance degradation. The current limit of 64k is chosen purely for visual aesthetics — more particles would make the effect too dense.
